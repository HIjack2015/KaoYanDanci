...
public class Constant {
    ...
    public static final String FEEDBACK_URL = SERVER_URL + "feedback/add";
    public static final String ADD_EASY_WORD_URL = SERVER_URL + "easyWord/add";
    ...
    public static final String ENGLISH_ZIP_PATH = ENGLISH_FILE_DIR + "/english.zip";
    public static final String VOICE_PACK_MD5 = "e11f8c98076f134da51fe22b2262dd85";//TODO;
    ...
    public static final String[] ENCOURAGE_SENTENCE = {"敢想不敢为者,终困身牢笼", "想要和得到 ,中间还有两个字,就是做到",
